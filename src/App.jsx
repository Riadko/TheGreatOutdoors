...
const WILAYAS_AR = [
  ...
  '54 - تيميمون', '55 - تقرت', '56 - جانت', '57 - إن صالح'
];

const COMMUNES_BY_WILAYA_AR = {
  '01 - أدرار': ['أدرار', 'الحطابة', 'أولف', 'رقان'],
  '02 - الشلف': ['الشلف', 'الشلف (حي شريفي قدور)', 'الشلف (حي النصر)', 'تنس'],
  '03 - الأغواط': ['أفلو', 'الأغواط'],
  '04 - أم البواقي': ['عين مليلة', 'أم البواقي'],
  '05 - باتنة': ['بريكة', 'باتنة', 'باتنة (حي الإخوة لمباركيا)'],
  '06 - بجاية': ['أقبو', 'بجاية (حي طوبال)', 'بجاية (إيديمكو)', 'القصر'],
  '07 - بسكرة': ['بسكرة', 'القنطرة', 'طولقة'],
  '08 - بشار': ['بشار', 'بشار (حي السلام)'],
  '09 - البليدة': ['البليدة', 'البليدة (باب الدزاير)', 'بوفاريك', 'بوعينان', 'الأربعاء', 'موزاية', 'أولاد يعيش'],
  '10 - البويرة': ['عين بسام', 'البويرة', 'الأخضرية', 'سور الغزلان'],
  '11 - تمنراست': ['تمنراست', 'تهقارت'],
  '12 - تبسة': ['الشريعة', 'تبسة', 'سكانسكا'],
  '13 - تلمسان': ['شتوان', 'مغنية', 'الرمشي', 'تلمسان', 'منصورة', 'الدالية'],
  '14 - تيارت': ['تيارت'],
  '15 - تيزي وزو': ['عزازقة', 'بني دوالة', 'ذراع بن خدة', 'تيزي غنيف', 'تيزي وزو', 'تيزي وزو (المدينة الجديدة)'],
  '16 - الجزائر': ['عين بنيان', 'الجزائر الوسطى', 'باب الوادي', 'باب الزوار', 'باش جراح', 'براقي', 'بئر مراد رايس', 'بئر خادم', 'بئر توتة', 'برج البحري', 'برج الكيفان', 'الشراقة (دار الضياف)', 'الشراقة (الهضبة)', 'الدار البيضاء', 'درارية', 'حسين داي', 'القبة', 'الكاليتوس', 'محلمة', 'المحمدية', 'وادي السمار', 'أولاد فايت', 'رغاية', 'رويبة', 'زرالدة'],
  '17 - الجلفة': ['عين وسارة', 'الجلفة'],
  '18 - جيجل': ['الميلية', 'جيجل', 'قاوس', 'الطاهير'],
  '19 - سطيف': ['عين أرنات', 'عين أولمان', 'بوقاعة', 'العلمة', 'العلمة (حي سوناطراك سمارة جنوب)', 'سطيف (تينار)', 'سطيف (معبودة)', 'سطيف (الهضاب)', 'سطيف (وسط المدينة)', 'سطيف (1014 مسكن)'],
  '20 - سعيدة': ['سعيدة'],
  '21 - سكيكدة': ['عزابة', 'القُل', 'الحروش', 'سكيكدة (مسيون)', 'سكيكدة (الأمل)', 'سكيكدة (فوبور)'],
  '22 - سيدي بلعباس': ['سيدي بلعباس', 'سيدي بلعباس (بن حمودة)'],
  '23 - عنابة': ['عنابة (فالماسكورت)', 'عنابة (سيدي ابراهيم)', 'عنابة (سيدي عاشور)', 'البوني'],
  '24 - قالمة': ['قالمة', 'وادي الزناتي'],
  '25 - قسنطينة': ['قسنطينة (بيل في)', 'قسنطينة (سيدي مبروك)', 'قسنطينة (زواغي)', 'ديدوش مراد', 'الخروب', 'الخروب (المدينة الجديدة علي منجلي)', 'الخروب (المدينة الجديدة)'],
  '26 - المدية': ['بني سليمان', 'المدية (المصلى)', 'المدية (القطب الحضري)', 'تابلاط'],
  '27 - مستغانم': ['مستغانم (سلامندر)', 'مستغانم (خروبة)'],
  '28 - المسيلة': ['برهوم', 'بوسعادة', 'المسيلة', 'سيدي عيسى'],
  '29 - معسكر': ['معسكر'],
  '30 - ورقلة': ['حاسي مسعود', 'ورقلة (وسط المدينة)', 'ورقلة (شطي الوكال)'],
  '31 - وهران': ['ارزيوه', 'بئر الجير (المرشد)', 'بئر الجير (فرنان فيل)', 'بئر الجير (إيلاف بلقايد)', 'وهران (حي جمال)', 'وهران (ڨامبيطا)', 'وهران (كناستيل)'],
  '32 - البيض': ['البيض'],
  '33 - إليزي': ['إليزي', 'إن أميناس'],
  '34 - برج بوعريريج': ['برج بوعريريج', 'برج بوعريريج (الثانوية الجديدة)', 'رأس الوادي'],
  '35 - بومرداس': ['برج منايل', 'بودواو', 'بومرداس', 'حمادي'],
  '36 - الطارف': ['الذرعان', 'الطارف'],
  '37 - تندوف': ['تندوف'],
  '38 - تسمسيلت': ['تسمسيلت'],
  '39 - الوادي': ['الوادي'],
  '40 - خنشلة': ['خنشلة'],
  '41 - سوق أهراس': ['سوق أهراس'],
  '42 - تيبازة': ['شرشال', 'حجوط', 'القليعة', 'تيبازة'],
  '43 - ميلة': ['شلغوم العيد', 'فرجيوة', 'ميلة (شارع الزرغية)', 'ميلة (شارع بن كارة)'],
  '44 - عين الدفلى': ['عين الدفلى (وسط المدينة)', 'عين الدفلى (حي خياط محمد)', 'خميس مليانة'],
  '45 - النعامة': ['مشرية'],
  '46 - عين تموشنت': ['عين تموشنت', 'بني صاف'],
  '47 - غرداية': ['بونورة', 'غرداية (الثنية)', 'غرداية (بوهراوة)'],
  '48 - غليزان': ['غليزان'],
  '49 - المغير': ['جامعة', 'المغير'],
  '50 - المنيعة': ['المنيعة'],
  '51 - أولاد جلال': ['أولاد جلال'],
  '52 - برج باجي مختار': ['برج باجي مختار'],
  '53 - بني عباس': ['بني عباس'],
  '54 - تيميمون': ['تيميمون'],
  '55 - تقرت': ['تقرت'],
  '56 - جانت': ['جانت'],
  '57 - إن صالح': ['إن صالح']
...
const COMMUNES_BY_WILAYA_AR_BY_CODE = Object.fromEntries(
  Object.entries(COMMUNES_BY_WILAYA_AR).map(([wilaya, communes]) => [getWilayaCode(wilaya), communes])
);
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      ...
                      <div>
                        ...
                        <select name="commune" value={formData.commune} onChange={handleInputChange} className="w-full px-4 py-3.5 bg-neutral-50 border border-neutral-200 rounded-2xl outline-none font-black text-sm appearance-none cursor-pointer">
                          {COMMUNES_BY_WILAYA[formData.wilaya]?.map((c, index) => {
                            const code = getWilayaCode(formData.wilaya);
                            const arLabel = COMMUNES_BY_WILAYA_AR_BY_CODE[code]?.[index];
                            return (
